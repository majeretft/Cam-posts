/**
  ...
  $Revision: 42576 73a8cc0eb6d86be1ef92d2a66405e5af135985ae $
  $Date: 2019-10-09 10:46:23 $
...
function onCyclePath() {
  if (hasParameter("operation:grooving") && getParameter("operation:grooving").toUpperCase() != "OFF") {
    error(localize("Grooving is unsupported in turning canned cycle."));
  }
...
function onCyclePathEnd() {
  ...
  case "turning-canned-rough": {
    var passDirection = getParameter("operation:profileRoughingCycle");
    writeBlock(gFormat.format(passDirection == "vertical passes" ? 72 : 71),
      (passDirection == "vertical passes" ? "W" : "U") + xyzFormat.format(cycle.depthOfCut),
